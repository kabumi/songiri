...
/*:ja
 * @plugindesc タイトル画面を出す前にオープニングデモから開始します。(※競合対策版byかぶみ)
 * @author Shirogane / smallomega.com
 *
 * @param firstMapId
 ...
 *
 *   Scene_Boot.prototype.startを書き換えているから注意！
 */
...
(function() {
    ...
    var parameters  = PluginManager.parameters('KAB_BootOpeningDemo');
    ...
    // プラグインコマンド
    KAB.OD._Game_Interpreter_pluginCommand =
        Game_Interpreter.prototype.pluginCommand;
    Game_Interpreter.prototype.pluginCommand = function (command, args)
    {
        KAB.OD._Game_Interpreter_pluginCommand.call(this, command, args);
        if (!openingDemoEnd)
        {
    ...
    KAB.OD._Scene_Boot_start = Scene_Boot.prototype.start;
    Scene_Boot.prototype.start = function()
    {
        if (DataManager.isBattleTest() || DataManager.isEventTest())
        {
            // デバッグ機能だけは通常の動作
            KAB.OD._Scene_Boot_start.call(this);
        }
        else
        {
            // 開始フラグリセット
    ...
    // デモ中は方向キー移動操作不可
    KAB.OD._Game_Player_moveByInput = Game_Player.prototype.moveByInput;
    Game_Player.prototype.moveByInput = function ()
    {
        if (openingDemoEnd)
        {
            return KAB.OD._Game_Player_moveByInput.call(this);
        }
    }

    // デモ中はマップのタッチ操作不可
    KAB.OD._Scene_Map_isMapTouchOk = Scene_Map.prototype.isMapTouchOk;
    Scene_Map.prototype.isMapTouchOk = function ()
    {
        // オープニングデモが終了していなければ実行しない
        if (openingDemoEnd)
        {
            return KAB.OD._Scene_Map_isMapTouchOk.call(this);
        }
    }

    // デモ中はメニュー操作不可
    KAB.OD._Scene_Map_isMenuCalled = Scene_Map.prototype.isMenuCalled;
    Scene_Map.prototype.isMenuCalled = function ()
    {
        // オープニングデモが終了していなければ常にfalse
        if (openingDemoEnd)
        {
            return KAB.OD._Scene_Map_isMenuCalled.call(this);
        }
        else
        {
            return false;
    ...
    // 決定キーで遷移、タッチ操作で遷移
    KAB.OD._Scene_Map_update = Scene_Map.prototype.update;
    Scene_Map.prototype.update = function ()
    {
        KAB.OD._Scene_Map_update.call(this);
    ...
    KAB.OD._Game_Interpreter_executeCommand = Game_Interpreter.prototype.executeCommand;
    Game_Interpreter.prototype.executeCommand = function ()
    {
        ...
        return KAB.OD._Game_Interpreter_executeCommand.call(this);
    }
})();
